# Source https://github.com/projectbluefin/common/commit/3664649e03afecc60cfa3e88b9bd0d63b2ee8a7a
# All this does is move the direnv sourcing back to where it was meant to be (before bash-preexec) to fix
# the fuck up done by https://github.com/projectbluefin/common/commit/3664649e03afecc60cfa3e88b9bd0d63b2ee8a7a.
#!/usr/bin/env sh
